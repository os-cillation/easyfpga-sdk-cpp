 ...
 */
class CanExtendedSyncTest : public Tester
{
    ...
    bool testMethod(void) {
        ...
        c1->init(Can::BITRATE::BITRATE_1M, Can::USAGE_MODE::EXTENDEND_MODE);
        c2->init(Can::BITRATE::BITRATE_1M, Can::USAGE_MODE::EXTENDEND_MODE);
        c3->init(Can::BITRATE::BITRATE_1M, Can::USAGE_MODE::EXTENDEND_MODE);
        ...
        canframe_ptr msg = std::make_shared<CanFrameExtended>(0x22 << 3, msgData, 5); /* << 3: 11 bits, 8 MSB are evaluated */
        canframe_ptr msgRTR = std::make_shared<CanFrameExtended>(0x22 << 3);
        canframe_ptr msgExt = std::make_shared<CanFrameExtended>(0x565656, msgData, 5);
