...
#include "easyfpga/easycores/uart/test/async/UartAsyncTestFpga.h"

UartAsyncTestFpga::UartAsyncTestFpga() :
...
void UartAsyncTestFpga::defineStructure(void)
{
...
uart_ptr UartAsyncTestFpga::getUart1(void)
{
    return _uart1;
}

uart_ptr UartAsyncTestFpga::getUart2(void)
{
    return _uart2;
}
