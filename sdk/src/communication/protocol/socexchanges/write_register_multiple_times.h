...
#ifndef SDK_COMMUNICATOR_PROTOCOL_SOCEXCHANGES_WRITEMULTIREGISTER_H_
#define SDK_COMMUNICATOR_PROTOCOL_SOCEXCHANGES_WRITEMULTIREGISTER_H_
...
/**
 * \brief Defines an soc operation for writing a register multiple times.
 *        (An soc context is neccessary.)
 */
class WriteMultiRegister : public Exchange
{
    public:
        /**
         * \brief Creates an WriteMultiRegister exchange
         *
         * \param core
         *
         ...
         * \param callback
         */
        WriteMultiRegister(byte core, byte registerAddress, uint8_t length, byte* data, callback_ptr callback) :
...
#endif  // SDK_COMMUNICATOR_PROTOCOL_SOCEXCHANGES_WRITEMULTIREGISTER_H_
