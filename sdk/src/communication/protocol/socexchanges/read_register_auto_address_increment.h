...
#ifndef SDK_COMMUNICATOR_PROTOCOL_SOCEXCHANGES_READAUTOADDRESSINCREMENTREGISTER_H_
#define SDK_COMMUNICATOR_PROTOCOL_SOCEXCHANGES_READAUTOADDRESSINCREMENTREGISTER_H_
...
/**
 * \brief Defines an soc operation for reading an consecutive sequence of
 *        registers. (An soc context is neccessary.)
 */
class ReadAutoAddressIncrementRegister : public Exchange
{
    public:
        /**
         * \brief Creates an ReadAutoAddressIncrementRegister exchange
         *
         * \param length
         *
         * \param target
         ...
         * \param callback
         */
        ReadAutoAddressIncrementRegister(uint8_t length, byte* target, byte core, byte registerAddress, callback_ptr callback) :
            Exchange(6, 1000000, 3+length, 4, (byte)0x90, callback),
            _length(length),
            _target(target),
            _core(core),
        ...
        ~ReadAutoAddressIncrementRegister()
        {
        }
...
#endif  // SDK_COMMUNICATOR_PROTOCOL_SOCEXCHANGES_READAUTOADDRESSINCREMENTREGISTER_H_
