...
#ifndef SDK_COMMUNICATOR_PROTOCOL_SOCEXCHANGES_READREGISTER_H_
#define SDK_COMMUNICATOR_PROTOCOL_SOCEXCHANGES_READREGISTER_H_
...
/**
 * \brief Defines an soc operation for reading a register. (An soc context is neccessary.)
 */
class ReadRegister : public Exchange
{
    public:
        /**
         * \brief Creates an ReadRegister exchange
         *
         * \param target
         *
         * \param core
         ...
         * \param callback
         */
        ReadRegister(byte* target, byte core, byte registerAddress, callback_ptr callback) :
            Exchange(5, 1000000, 4, 4, (byte)0x88, callback),
            _target(target),
            _core(core),
        ...
        frame_ptr getRequest(void)
        {
            if (_request == NULL) {
                ...
                requestBuffer[0] = (byte)0x77;
                requestBuffer[1] = (byte)_id;
                requestBuffer[2] = _core;
                requestBuffer[3] = _registerAddress;
                requestBuffer[4] = Calculator::calculateXorParity(requestBuffer, 4);
...
#endif  // SDK_COMMUNICATOR_PROTOCOL_SOCEXCHANGES_READREGISTER_H_
